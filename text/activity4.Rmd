...
**Exercise 1**. Leaving $\eta_{0}$ and ${r}_{0}$ at their default values, examine the trained grid after one iteration and after 25 iterations. You will find it helpful to go back-and-forth between the limits on iterations. In what ways are the trained grids similar to each other and in what ways are they different from each other. How successful is the SOM in locating the new sample?  *Note: There is a delay in updating the grid as the number of iterations increases*.
